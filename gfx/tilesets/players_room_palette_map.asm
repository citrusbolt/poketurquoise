...
endr
	...
	tilepal 1, GRAY, GRAY, WATER, WATER, GRAY, GRAY, GRAY, GREEN
	tilepal 1, GREEN, RED, RED, GRAY, GRAY, RED, RED, RED
	tilepal 1, GRAY, GRAY, BROWN, GRAY, GRAY, GRAY, GRAY, GREEN
	tilepal 1, GREEN, RED, RED, GRAY, GRAY, WATER, RED, RED
	tilepal 1, GRAY, GRAY, BROWN, BROWN, GRAY, GRAY, GRAY, GREEN
