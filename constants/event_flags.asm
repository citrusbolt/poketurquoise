...
;New to Turquoise
	const EVENT_CAF_FIEND_NEEDS_COFFEE
	const EVENT_MET_OAK
	const EVENT_TIME_TO_CHOOSE_STARTER
	...
	const EVENT_GOT_MAP_FROM_DAISY
	const EVENT_GOT_POTION_SAMPLE
	const EVENT_RIVAL_OAKS_LAB
	const EVENT_RIVAL_ROUTE_22
	const EVENT_RIVAL_CERULEAN
	const EVENT_RIVAL_SHIP
	const EVENT_RIVAL_TOWER
	const EVENT_RIVAL_SILPH
	const EVENT_RIVAL_ROUTE_22_2
	const EVENT_RIVAL_CHAMP
